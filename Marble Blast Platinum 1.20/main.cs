...
//$baseMods = "platinumbeta";
$userMods = "platinumbeta";
$displayHelp = false;
...
//HiGuy: Get the full path of a file
function getFullPath(%path)
{
	// Jeff: make OS compatible
	%ds = ($platform $= "windows") ? "\\" : "/";
	//HiGuy: Not sure we can get the name of their home folder from script...
	%base = ($platform $= "windows" ? $Game::argv[0] : "<Home Folder>/Library/MarbleBlast/");
...
// Jeff: more dev mode code here, remove all of it before release:
schedule(200,0,"exec",$usermods @ "/dev/cyclicRedundancyCheckGen.cs");
